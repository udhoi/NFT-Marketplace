...
contract NFTMarketplace is ReentrancyGuard, ERC721URIStorage, Ownable{
    ...
    function customToken(address gotAddress) public onlyOwner{
        ...
        _customToken = PRAYToken(gotAddress);
    }
    ...
    function sellNFT(uint256 tokenId, uint256 marketItemPrice, uint256 sellerGets, uint256 marketOwnerGets, address tokenAddress) public payable nonReentrant{
