...
describe("NFT Marketplace (Function Calls)", function(){
    ...
    it("Listing Market Item", async function(){
        ...
        let listFee = "1";
        console.log("Owner Amount in ethers: " + ethers.utils.parseUnits(transferAmountOwner,"ether"));
        console.log("User Amount in ethers: " + ethers.utils.parseUnits(transferAmountUser,"ether"));
        console.log("listFee in ethers: " + ethers.utils.parseUnits(listFee,"ether"));
        ...
        if(await nftmarket.usingCustomToken()){
            ...
            await mahToken.connect(addr1).approve(nftmarket.address, listFee);
