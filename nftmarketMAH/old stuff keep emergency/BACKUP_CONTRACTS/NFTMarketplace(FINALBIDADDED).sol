...
contract NFTMarketplace is ReentrancyGuard, ERC721URIStorage, Ownable{
    ...
    function unlistNFT(uint256 tokenId) public {
        require((msg.sender == MarketItemDatabase[tokenId].nftCreator && MarketItemDatabase[tokenId].nftOwner == address(0)) || msg.sender == MarketItemDatabase[tokenId].nftOwner, "ERR:7");
    ...
    function bidWalletOUT(uint256 withdrawAmount) public payable nonReentrant{
        require(msg.sender != marketOwner, "ERR:17");
        require(mpWallets[msg.sender] >= withdrawAmount, "ERR:19");
        mpWallets[msg.sender] = mpWallets[msg.sender] - withdrawAmount;
